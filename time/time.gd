...
signal current_cycle_changed(cycle)
...
const IN_GAME_SECONDS_PER_REAL_TIME_SECONDS: int = 3600 / 4 #/ 10
...
var state_transition_seconds: int = 16600
...
func _set_current_cycle(cycle):
	...
	emit_signal("current_cycle_changed", cycle)
